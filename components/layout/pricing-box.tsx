...
const PricingBox = () => {
  ...
  return (
    <div className="flex gap-16">
      <div className="shadow-xl bg-white px-5 py-6 rounded-4xl z-10 overflow-hidden border-3 border-transparent ">
      ...
      <div className="shadow-xl bg-white px-5 py-6 rounded-4xl z-10 overflow-hidden border-3 border-transparent ">
        <div className="flex flex-col items-start gap-2 px- pb-3 relative ">
          <div className="bg-blue-400 h-32 w-42 absolute -top-29 right-15 rounded-full blur-2xl "></div>
          <div className="bg-orange-400 h-10 w-20 absolute bottom-0 -left-10  blur-xl "></div>
          <div className="bg-orange-400 h-10 w-20 absolute bottom-0 -right-10  blur-xl "></div>
          ...
          <span className="mt-4 w-full z-20">
            <Button className="w-full py-5.5 text-base shadow rounded-xl inset-shadow-white bg-neutral-900 inset-shadow-xs ">
              Get Started
            </Button>
          </span>
        </div>
