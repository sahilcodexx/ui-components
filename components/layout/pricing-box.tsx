  ...
  return (
    <Container className="flex items-center justify-center">
      <div className="flex flex-col items-center justify-center  md:flex-row  gap-16">
        <div className="shadow-xl dark:shadow-neutral-900/10 bg-white dark:bg-neutral-800/40 dark:ring-neutral-700/40 dark:ring px-5 py-6 rounded-4xl z-10 overflow-hidden border-3 border-transparent ">
          <div className="flex flex-col items-start gap-2 px- pb-3   ">
            ...
            <span className="mt-4 w-full z-20">
              <Button className="w-full py-5.5 text-base shadow-md border border-neutral-400/50 hover:bg-neutral-300 cursor-pointer text-black rounded-xl inset-shadow-white bg-neutral-200 dark:bg-neutral-300  inset-shadow-2xs ">
                Get Started
              </Button>
            </span>
          </div>
          ...
          <div className="  py-6">
            {features.map((feature, index) => (
              <div
                key={index}
                className="flex items-center mt-2 dark:text-neutral-400 text-base font-semibold text-neutral-700 justify-start gap-2"
              >
                {feature.icon}
        ...
        <div className="shadow-xl bg-white dark:bg-linear-to-bl dark:bg-neutral-900/50 dark:ring-neutral-700/40 dark:ring px-5 py-6 rounded-4xl z-10 overflow-hidden border-3 border-transparent  ">
          <div className="flex flex-col items-start gap-2 px- pb-3 relative ">
            ...
            <span className="mt-4 w-full z-20">
              <Button className="w-full py-5.5 text-base shadow rounded-xl inset-shadow-white dark:inset-shadow-neutral-600 bg-neutral-900 dark:bg-neutral-100 inset-shadow-xs dark:ring dark:inset-shadow-2xs dark:shadow-neutral-500  ">
                Get Started
              </Button>
            </span>
          </div>
          <div className="mt-4  py-6">
            {proFeatures.map((feature, index) => (
              <div
                key={index}
                className="flex items-center mt-2 text-base font-semibold text-neutral-700 dark:text-neutral-200 justify-start gap-2"
              >
                {feature.icon}
                <div className="ml-1">{feature.text}</div>
              </div>
